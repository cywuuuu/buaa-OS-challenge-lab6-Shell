...
///////////////////////////////////////////////////// new
int get_his(char his[][256]) ; 
void save_his(char s[]) ; 
void create_his() ; 
void curpath_init(int faid, char *path);
int curpath_get(int faid, char *path);
int curpath_set(int faid, char *path);
int curpath_get_parent(int faid, char *path);
...
u_int syscall_getfaid(u_int envid); 
...
int syscall_var_set(u_int envid, char *name, char *val, int op, int perm); 
int syscall_var_get(u_int envid, char *name, char *val, int op); 
...
#define O_APPEND	0x1000		/* NEW:APPEND */
